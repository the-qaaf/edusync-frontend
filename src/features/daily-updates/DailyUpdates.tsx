...
import { Share2, BookOpen, Calendar, Filter, ExternalLink } from "lucide-react";
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredUpdates.map((update) => (
            <Card
              key={update.id}
              className="flex flex-col h-full hover:shadow-md transition-shadow animate-in fade-in duration-300"
            >
              <div className="flex justify-between items-start mb-4">
                <div>
